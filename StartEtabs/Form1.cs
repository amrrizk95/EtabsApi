...
namespace StartEtabs
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string ProgramPath;
            ProgramPath = "C:\\Program Files\\Computers and Structures\\ETABS.exe";

            //full path to the model 
            //set it to an already existing folder 
            string ModelDirectory = "E:\\projectswork\\etabsModels";
            try
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // set path 
            string ModelDirectory = "E:\\projectswork\\etabsModels";
            string ModelName = "ETABS_API_Columns.edb";
            string ModelPath = ModelDirectory + System.IO.Path.DirectorySeparatorChar + ModelName;
            ...
            //start ETABS application
            var ret = myETABSObject.ApplicationStart();
            //Initialize model
            ret = mySapModel.InitializeNewModel(eUnits.Ton_m_C);
            // open new blank model
            ret = mySapModel.File.NewBlank();
             string name = "columnsApi";
            ret = mySapModel.FrameObj.AddByCoord(0, 10, 0, 0, 0, 10, ref name, "Default", "Amr", "Global");
